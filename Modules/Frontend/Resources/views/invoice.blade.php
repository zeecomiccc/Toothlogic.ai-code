...
<head>
    ...
    <style>
        ...
        body {
            font-family: {{ config('dompdf.default_font') }}, Arial, sans-serif;
            font-size: 12px;
            line-height: 1.4;
            color: #333;
            margin: 0;
                            ...
                            <div style="font-size: 12px; line-height: 1.6;">
                                ...
                                @if ($info['user']['date_of_birth'] !== null)
                                    <div><strong>{{ __('invoice.date_of_birth') }}:</strong>
                                        {{ formatDate($info['user']['date_of_birth']) ?? '--' }}
                                    </div>
                                @endif
                            </div>
                        </td>
                        ...
                        <div style="padding: 15px; font-size: 12px;">
                            ...
                            {{-- @foreach ($taxData as $taxPercentage)
                                @php
                                    ...
                                    // Calculate tax amount based on type - matching billing_detail logic
                            ...
                            <table width="100%" class="summary-row paid">
                                <tr>
