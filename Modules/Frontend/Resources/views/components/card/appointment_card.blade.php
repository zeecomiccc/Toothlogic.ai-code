...
<div class="modal fade" id="encounter-details-view-{{ $appointment->id }}">
                        ...
                        <div class="clinical-details">
                            ...
                            <div class="encounter-section mb-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @php
                                            $medicalReports = optional($appointment->patientEncounter)->medicalReports ?? collect();
                                        @endphp
                            ...
                            <div class="encounter-section mb-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @php
                                            $orthodonticRecords = optional($appointment->patientEncounter)->orthodonticDailyRecords ?? collect();
                                        @endphp
                                        @if($orthodonticRecords->isNotEmpty())
                                            <div class="table-responsive">
