...
@section('container')
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="http://127.0.0.1:8000" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
                ...
                <div class="buttons">
                    <button class="button intsaller-btn" id="database-setting"  onclick="showDatabaseSettings();return false">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="buttons">
                    <button class="button intsaller-btn" id="application_setting" onclick="showApplicationSettings();return false">
            ...
            <div class="tab" id="tab3content">
                ...
                <div class="buttons">
                    <button class="button intsaller-btn" id="submit-data" type="submit" onclick="disableButton()">
...
@section('scripts')
    <script type="text/javascript">
        ...
        function showDatabaseSettings() {
            ...
            document.getElementById('database-setting').classList.add('disabled');
            document.getElementById('tab2').checked = true;

            document.getElementById('database-setting').classList.remove('disabled');
        }
        function showApplicationSettings() {

            document.getElementById('application_setting').classList.add('disabled');

            document.getElementById('tab3').checked = true;

            document.getElementById('application_setting').classList.remove('disabled');
        }
