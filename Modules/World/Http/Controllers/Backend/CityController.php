...
{
    // use Authorizable;
    protected string $exportClass = '\App\Exports\CityExport';
    ...
    public function index(Request $request)
    {
        ...
        $export_columns = [
            ...
            [
                'value' => 'state_name',
                'text' => __('service.lbl_city_column_name'),
            ],
            [
                'value' => 'status',
        ...
        $export_url = route('backend.city.export');
        return view('world::backend.city.index_datatable', compact('module_action', 'filter', 'columns', 'customefield', 'export_import', 'export_columns', 'export_url', 'state'));
    }
    ...
    public function index_data(Request $request)
    {
        ...
        return $datatable->rawColumns(array_merge(['action', 'status', 'name', 'state_name', 'check'], $customFieldColumns))
            ->toJson();
    }
