    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="form-offcanvas" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-body">
        <div class="col-md-12 form-group">
          <label class="form-label">{{ $t('messages.name') }} <span class="text-danger">*</span></label>
          <InputField type="text" :is-required="true" :label="$t('messages.name')" placeholder="" v-model="name" :error-message="errors['name']" :error-messages="errorMessages['name']"></InputField>
        </div>
        <div class="col-md-12 form-group">
