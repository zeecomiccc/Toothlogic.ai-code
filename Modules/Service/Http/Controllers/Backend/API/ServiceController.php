...
class ServiceController extends Controller
{
    ...
    public function assign_service_provider_list($id)
    {
        ...
        return $this->sendResponse($service_service_provider, __('service.service_provider_service'));
    }
    ...
    public function assign_service_provider_update($id, Request $request)
    {
        ...
        return $this->sendResponse($id, __('service.service_provider_service_update'));
    }
    ...
    public function serviceList(Request $request)
    {
        ...
        $services = Service::with(['media', 'service_providers', 'employee']);
        if ($request->has('service_provider_id')) {
            $services = $services->whereHas('service_providers', function ($query) use ($service_provider_id) {
    ...
    {
        $services = Service::where('status', 1)->with(['category', 'sub_category', 'service_providers']);
        ...
        if ($request->has('service_provider_id')) {
            $services->whereHas('service_providers', function ($query) use ($request) {
