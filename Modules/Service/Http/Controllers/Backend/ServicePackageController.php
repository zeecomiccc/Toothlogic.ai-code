...
class ServicePackageController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['permission:view_service_package'])->only('index');
        $this->middleware(['permission:edit_service_package'])->only('edit', 'update');
        $this->middleware(['permission:add_service_package'])->only('store');
        $this->middleware(['permission:delete_service_package'])->only('destroy');
    }
