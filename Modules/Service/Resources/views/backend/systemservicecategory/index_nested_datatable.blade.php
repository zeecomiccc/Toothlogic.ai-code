...
@section('content')
            ...
            <x-slot name="toolbar">
                ...
                @hasPermission('add_system_category')
                    <button type="button" class="btn btn-primary" data-crud-id="{{ 0 }}"
                        ...
                        {{ __('category.sub_categories') }}</button>
                @endhasPermission
    ...
    <div data-render="app">
        <system-service-category-form-offcanvas :is-sub-category="true" default-image="{{ default_file_url() }}"
            ...
            :category-id="{{ isset($category->id) ? $category->id : null }}"></system-service-category-form-offcanvas>
    </div>
@endsection
