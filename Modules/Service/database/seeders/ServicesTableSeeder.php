        ...
        if (env('IS_DUMMY_DATA')) {
            $data = [
                ...
                [
                    ...
                    'default_price' => 50.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 12.webp'),
                    'category' => 'hair',
                ...
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 10.webp'),
                    'category' => 'hair',
                    'sub_category' => 'haircuts',
                ],
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 24.webp'),
                    'category' => 'hair',
                    'sub_category' => 'haircuts',
                ],
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 19.webp'),
                    'category' => 'hair',
                    'sub_category' => 'haircuts',
                ],
                [
                    ...
                    'default_price' => 100.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 25.webp'),
                    'category' => 'hair',
                    'sub_category' => 'haircuts',
                ],
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 40.webp'),
                    'category' => 'hair',
                ...
                [
                    ...
                    'default_price' => 200.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 3.webp'),
                    'category' => 'hair',
                    'sub_category' => 'hairstyling',
                ],
                [
                    ...
                    'default_price' => 200.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 8.webp'),
                    'category' => 'hair',
                    'sub_category' => 'hairstyling',
                ],
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 35.webp'),
                    'category' => 'hair',
                    'sub_category' => 'haircuts',
                ],
                [
                ...
                [
                    ...
                    'default_price' => 100.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 4.webp'),
                    'category' => 'grooming',
                    'sub_category' => 'shaving',
                ],
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 1.webp'),
                    'category' => 'grooming',
                    'sub_category' => 'facial',
                ],
                ...
                [
                    ...
                    'default_price' => 150.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 30.webp'),
                    'category' => 'grooming',
                ...
                [
                    ...
                    'default_price' => 200.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 21.webp'),
                    'category' => 'grooming',
                    'sub_category' => 'relaxation',
                ],
                ...
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 34.webp'),
                    'category' => 'nail-care',
                ...
                [
                    ...
                    'default_price' => 2500.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 43.webp'),
                    'category' => 'nail-care',
                    'sub_category' => 'pedicure',
                ],
                ...
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 41.webp'),
                ...
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 39.webp'),
                    'category' => 'hair-treatments',
                    'sub_category' => 'scalp-treatments',
                ],
                ...
                [
                    ...
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 44.webp'),
                ...
                [
                    ...
                    'default_price' => 400.00,
                    'status' => 1,
                    'file_url' => public_path('/dummy-images/common/Service 27.webp'),
                    'category' => 'spa-packages',
                    'sub_category' => 'relaxation-package',
                ],
            ];
            foreach ($data as $key => $value) {
                ...
                $serviceData = Arr::except($value, ['sub_category', 'category', 'file_url']);
