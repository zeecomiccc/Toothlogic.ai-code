  ...
  <form @submit="formSubmit">
    <div class="offcanvas offcanvas-end" tabindex="-1" id="form-offcanvas" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <InputField class="col-md-12" :is-required="true" :label="$t('service_providers.lbl_shop_number')" placeholder="" v-model="address_line_1" :error-message="errors['address.address_line_1']" :error-messages="errorMessages['address_line_1']"></InputField>
        <InputField class="col-md-12" :label="$t('service_providers.lbl_landmark')" placeholder="" v-model="address_line_2" :error-message="errors['address.address_line_2']" :error-messages="errorMessages['address_line_2']"></InputField>

        <div class="form-group col-md-12">
          <label class="form-label">{{ $t('service_providers.lbl_country') }} </label>
        ...
        <div class="form-group col-md-12">
          <label class="form-label" for="State">{{ $t('service_providers.lbl_state') }}</label>
        ...
        <div class="form-group col-md-12">
          <label class="form-label" for="City">{{ $t('service_providers.lbl_city') }}</label>
          <Multiselect v-model="city" :value="city" :options="cityList.options" v-bind="singleSelectOption" id="city" ></Multiselect>
        </div>

        <InputField class="col-md-12" type="text"  :label="$t('service_providers.lbl_postal_code')" placeholder="" v-model="pincode" :error-message="errors['pincode']" :error-messages="errorMessages['pincode']"></InputField>
