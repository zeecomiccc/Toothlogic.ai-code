        ...
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                @can('edit_'.$module_name)
                    <button type="button" class="btn btn-primary btn-icon btn-sm" data-bs-toggle="offcanvas" data-bs-target="#form-offcanvas" data-crud-id="{{$$module_name_singular->id}}" title="{{ __('messages.edit') }} " data-bs-toggle="tooltip"> <i class="ph ph-pencil-simple-line"></i></button>
                @endcan
