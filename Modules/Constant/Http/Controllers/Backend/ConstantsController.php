...
class ConstantsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('constant::backend.constants.index_datatable', compact('module_action', 'columns', 'customefield','filter', 'export_import', 'export_columns', 'export_url'));
    }
    ...
    public function bulk_action(Request $request)
    {
        ...
        switch ($actionType) {
            case 'change-status':
                $service_providers = Constant::whereIn('id', $ids)->update(['status' => $request->status]);
