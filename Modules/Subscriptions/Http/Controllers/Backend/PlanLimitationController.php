...
class PlanLimitationController extends Controller
{
    ...
    public function index()
    {
        ...
        $customefield = CustomField::exportCustomFields(new PlanLimitation());
        ...
        $export_url = route('backend.subscription.planlimitation.export');

        return view('subscriptions::backend.planlimitation.index', compact('module_action', 'columns', 'customefield', 'export_import', 'export_columns', 'export_url'));
    ...
    public function bulk_action(Request $request)
    {
        ...
        switch ($actionType) {
            case 'change-status':
                $service_providers = PlanLimitation::whereIn('id', $ids)->update(['status' => $request->status]);
