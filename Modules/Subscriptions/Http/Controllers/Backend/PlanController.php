...
class PlanController extends Controller
{
    ...
    public function index()
    {
        ...
        $export_url = route('backend.subscription.plans.export');
        return view('subscriptions::backend.plan.index', compact('module_action', 'module_name' , 'columns', 'customefield', 'export_import', 'export_columns', 'export_url'));
    }
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        return $datatable->rawColumns(array_merge(['action','name', 'type', 'duration', 'amount', 'planlimitation', 'status', 'check'], $customFieldColumns))
            ->toJson();
    }
