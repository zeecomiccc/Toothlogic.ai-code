...
class NotificationTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $types = [
            ...
            [
                'type' => 'notification_type',
                'value' => 'upcoming_appointment_reminder',
...
<p>[[ logged_in_user_fullname ]]<br>[[ logged_in_user_role ]]<br>[[ company_name ]]<br>[[ company_contact_info ]]</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<p>Your wallet has been credited with a refund [[ refund_amount ]]
                                            </p>',
            'mail_template_detail' => '<p>Your wallet has been credited with a refund [[ refund_amount ]]</p>',
            'sms_template_detail' => '<p>Your wallet has been credited with a refund [[ refund_amount ]]</p>',
            'whatsapp_template_detail' => 'Your wallet has been credited with a refund [[ refund_amount ]]</p>',
        ]);
        ...
        $template = NotificationTemplate::create([
            ...
            'status' => 1,
            'to' => '["user", "doctor"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_CUSTOM_WEBHOOK' => '0', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);

        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'Reminder: Your appointment with Dr. [[ doctor_name ]] is scheduled for [[ appointment_date ]] at [[ appointment_time ]].',
            'status' => 1,
            'subject' => 'Upcoming Appointment Reminder',
            'user_type' => 'admin',
            'template_detail' => '<p>Your appointment with Dr. [[ doctor_name ]] is scheduled for [[ appointment_date ]] at [[ appointment_time ]]. Please arrive on time.</p>',
            'mail_template_detail' => '<p>Dear [[ user_name ]],</p><p>This is a friendly reminder for your appointment scheduled on [[ appointment_date ]] at [[ appointment_time ]] with Dr. [[ doctor_name ]].</p><p>Location: [[ venue_address ]]</p><p>Thank you,<br>[[ company_name ]]</p>',
            'mail_subject' => 'Reminder: Appointment on [[ appointment_date ]] at [[ appointment_time ]]',
            'sms_template_detail' => 'Reminder: Appointment with Dr. [[ doctor_name ]] on [[ appointment_date ]] at [[ appointment_time ]], Location: [[ venue_address ]]',
            'sms_subject' => 'Upcoming Appointment Reminder',
            'whatsapp_template_detail' => 'Hi [[ user_name ]], this is a reminder for your appointment on [[ appointment_date ]] at [[ appointment_time ]] with Dr. [[ doctor_name ]].',
            'whatsapp_subject' => 'Appointment Reminder',
        ]);
    }
}
