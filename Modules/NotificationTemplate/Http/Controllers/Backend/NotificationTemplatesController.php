...
class NotificationTemplatesController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        $rules = [
            ...
            'defaultNotificationTemplateMap.user_type' => 'required|string',
            'defaultNotificationTemplateMap.subject' => 'required|string',
            'defaultNotificationTemplateMap.template_detail' => 'required|string',
            'defaultNotificationTemplateMap.mail_subject' => 'required|string',
            'defaultNotificationTemplateMap.mail_template_detail' => 'required|string',
            'defaultNotificationTemplateMap.sms_subject' => 'required|string',
            'defaultNotificationTemplateMap.sms_template_detail' => 'required|string',
            'defaultNotificationTemplateMap.whatsapp_subject' => 'required|string',
            'defaultNotificationTemplateMap.whatsapp_template_detail' => 'required|string',
        ...
        if ($check !== null) {
            ...
            if ($data !== null) {
                $map = $validatedData['defaultNotificationTemplateMap'];
                $data->update([
                    'subject' => $map['subject'],
                ...
                $data->template->update([
                    ...
                    'bcc' => isset($validatedData['bcc']) ? json_encode($validatedData['bcc']) : null,
                    'cc' => isset($validatedData['cc']) ? json_encode($validatedData['cc']) : null,
            ...
            $data->defaultNotificationTemplateMap()->create(
                array_merge(
                    $validatedData['defaultNotificationTemplateMap'],
                    [
                        'mail_subject' => $validatedData['defaultNotificationTemplateMap']['mail_subject'],
                        'mail_template_detail' => $validatedData['defaultNotificationTemplateMap']['mail_template_detail']
                    ]
                )
            );
