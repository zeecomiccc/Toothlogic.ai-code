...
export const CATEGORY_LIST = ({type = ''}) => {return {path: `${MODULE}/slider_list/${type}`, method: 'GET'}}

export const SERVICE_LIST = ({type = ''}) => {return {path: `${MODULE}/slider_list/${type}`, method: 'GET'}}
