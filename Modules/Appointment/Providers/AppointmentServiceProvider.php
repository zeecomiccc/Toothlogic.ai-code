...
class AppointmentServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // register commands
        $this->registerCommands('\Modules\Appointment\Console\Commands');
    }
    ...
    {
        $this->publishes([
            base_path('Modules/Appointment/Config/config.php') => config_path($this->moduleNameLower.'.php'),
        ], 'config');
        $this->mergeConfigFrom(
            base_path('Modules/Appointment/Config/config.php'), $this->moduleNameLower
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = base_path('Modules/Appointment/Resources/views');
