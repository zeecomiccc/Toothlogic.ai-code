        ...
        <div class="offcanvas-body">
          ...
          <!-- <div class="form-group">
            <div class="d-flex justify-content-between align-items-center">
              <label class="form-label" for="file_url">{{ $t('service.lbl_file_url') }} </label>
              <a href="javascript:void(0)" v-if="file_url" class="text-danger" @click="removeImage">Remove</a>
            </div>
            <input type="file" class="form-control" id="file_url" ref="refInput" @change="fileUpload" accept=".jpeg, .jpg, .png, .gif" />
