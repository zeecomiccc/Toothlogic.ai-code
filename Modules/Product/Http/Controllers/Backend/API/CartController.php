...
class CartController extends Controller
{
    public function getCartList(Request $request)
    {
        ...
        // $tax_amount = $cart->isEmpty() ? null : getTaxamount($sumOfPrices - $discount_price); // Tax calculation disabled
        $tax_amount = null; // Tax calculation disabled
        $total_payable_amount = $cart->isEmpty() ? 0 : ($sumOfPrices - $discount_price); // Tax calculation disabled
        ...
        $amount = [
            ...
            'tax_data' => $tax_amount,
            'tax_amount' => 0, // Tax calculation disabled
