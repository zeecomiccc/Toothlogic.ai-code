      ...
      <div class="offcanvas-body">
        <div class="row">
          <div class="col-12 row">
            <div class="col-12 row">
              <div class="col-md-6">
                <InputField class="col-md-12" :is-required="true" :label="$t('service_providers.lbl_service_provider_name')" placeholder="" v-model="name" :error-message="errors.name" :error-messages="errorMessages['name']"></InputField>
              </div>
            ...
            <div class="form-group col-md-12">
              <div class="d-flex justify-content-between">
                <label for="manager_id">{{ $t('service_providers.lbl_select_manager') }} <span class="text-danger">*</span></label>
            ...
            <InputField class="col-md-6" :is-required="true" :label="$t('service_providers.lbl_contact_email')" placeholder="" v-model="contact_email" :error-message="errors.contact_email" :error-messages="errorMessages['contact_email']"></InputField>
            <InputField class="col-md-6" :is-required="true" :label="$t('service_providers.lbl_shop_number')" placeholder="" v-model="address_line_1" :error-message="errors['address.address_line_1']" :error-messages="errorMessages['address_line_1']"></InputField>
            <InputField class="col-md-6" :label="$t('service_providers.lbl_landmark')" placeholder="" v-model="address_line_2" :error-message="errors['address.address_line_2']" :error-messages="errorMessages['address_line_2']"></InputField>
            <div class="col-md-2 form-group">
              <label class="form-label">{{ $t('service_providers.lbl_country') }} <span class="text-danger">*</span></label>
            ...
            <div class="col-md-2 form-group">
              <label class="form-label">{{ $t('service_providers.lbl_state') }} <span class="text-danger">*</span></label>
            ...
            <div class="col-md-2 form-group">
              <label class="form-label">{{ $t('service_providers.lbl_city') }}<span class="text-danger">*</span></label>
            ...
            <InputField class="col-md-2" type="number" :is-required="true" :label="$t('service_providers.lbl_postal_code')" placeholder="" v-model="postal_code" :error-message="errors['address.postal_code']" :error-messages="errorMessages['postal_code']"></InputField>
            <InputField class="col-md-2" :is-required="true" :label="$t('service_providers.lbl_lat')" placeholder="" v-model="latitude" :error-message="errors['address.latitude']" :error-messages="errorMessages['latitude']"></InputField>
            <InputField class="col-md-2" :is-required="true" :label="$t('service_providers.lbl_long')" placeholder="" v-model="longitude" :error-message="errors['address.longitude']" :error-messages="errorMessages['longitude']"></InputField>
            ...
            <div class="form-group col-md-2">
              <div class="d-flex gap-3">
                <label class="form-label" for="category-status">{{ $t('service_providers.lbl_status') }}</label>
...
import { EDIT_URL, STORE_URL, UPDATE_URL, SERVICE_LIST, EMPLOYEE_LIST, COUNTRY_URL, STATE_URL, CITY_URL } from '../../constants/service_provider'
...
const validationSchema = yup.object({
  ...
  manager_id: yup
    .string()
    .required('Assign Manager is a required field')
