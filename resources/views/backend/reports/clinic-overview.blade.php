    ...
    <div class="row">
        <div class="col-md-12">
                                ...
                                <x-slot name="toolbar">
                                    <div class="input-group gap-2 flex-nowrap">
                                        <input type="text" name="appointment_date" id="appointment_date"
                                            placeholder="{{ __('setting_sidebar.select_date') }}"
                                            class="booking-date-range form-control ps-3" readonly />
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                    <a href="{{ route('backend.earnings.index') }}" class="text-secondary">
                        <div class="card dashboard-cards appointments">
                            <div class="card-body">
                                <p class="mb-0">{{ __('appointment.doctor_commission') }}</p>
                                <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                                    <h2 class="mb-0" id="totalDoctorCommission">
                                        {{ \Currency::format($totalDoctorCommission) }}</h2>
                        ...
                        <a href="{{ route('backend.earnings.index') }}" class="text-secondary">
                            <div class="card dashboard-cards appointments">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                                        <h2 class="mb-0" id="totalAdminCommission">
                                            {{ \Currency::format($totalAdminCommission) }}</h2>
                ...
                @else
                    <div class="col-sm-6 col-lg-3">
                        <a href="{{ route('backend.clinics.index') }}" class="text-secondary">
                            <div class="card dashboard-cards appointments">
                                <div class="card-body">
                                    <p class="mb-0">{{ __('dashboard.total_number_of') }}
                                        {{ __('appointment.lbl_clinic') }}
                                    </p>
                                    <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                    ...
                    <a href="{{ route('backend.earnings.index') }}" class="text-secondary">
                        <div class="card dashboard-cards appointments">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                                    @if (multiVendor() == 1)
                                        <h2 class="mb-0" id="totalClinicRevenue">
