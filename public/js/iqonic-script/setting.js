...
;(function (window) {
  ...
  IQSetting.prototype.resetFontFamily = function () {
    ...
    const bodyFamily = '"Poppins", sans-serif'
    const headingFamily = '"Poppins", sans-serif'
    if (typeof $ !== typeof undefined) {
    ...
    this.setSettingOption('body_font_family', 'Poppins', true)
    this.setSettingOption('heading_font_family', 'Poppins', true)
  ...
  if (resetFont !== null) {
    resetFont.addEventListener('click', (e) => {
      e.preventDefault()
      this.IQSetting.setSettingOption('body_font_family', 'Poppins', true)
      this.IQSetting.setSettingOption('heading_font_family', 'Poppins', true)
