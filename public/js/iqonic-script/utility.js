...
(function () {
    ...
    this.IQUtils.getVariableColor = () => {
      ...
      const color6 = getComputedStyle(document.body).getPropertyValue(`--${prefix}heading-color`);
      const color7 = getComputedStyle(document.body).getPropertyValue(`--${prefix}gray-900`);
      return {
        primary: color1.trim(),
        info: color2.trim(),
        warning: color4.trim(),
