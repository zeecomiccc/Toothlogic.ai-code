...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // $schedule->command('appointments:send-mail-upcoming-appointment-reminders')->everyTenMinutes();
        $schedule->command('appointments:send-mail-upcoming-appointment-reminders')->everyMinute();
    }
